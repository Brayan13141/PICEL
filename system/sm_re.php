...
/**
 * Archivo: /c:/wamp64/www/PICEL-master/PICEL-master/system/sm_re.php
 *
 * Este archivo maneja las operaciones de cancelación, actualización, eliminación e inserción de registros de estudiantes.
 *
 * Variables principales:
 * - $link: Conexión a la base de datos.
 * - $_SESSION: Variables de sesión para manejar el estado de edición y el ID del estudiante a editar.
 * - $_POST: Datos enviados desde el formulario.
 *
 * Funciones:
 * - antiscript($data): Función para limpiar y sanitizar los datos de entrada.
 *
 * Operaciones:
 * - Cancelar actualización: Si se recibe el parámetro 'cancel', se reinician las variables de sesión y se redirige a lapágina principal.
 * - Actualizar o eliminar registro: Si se recibe el parámetro 'accion' con los valores 'eliminar_registro' o 'editar_registro', se realiza la operación correspondiente.
 * - Insertar o actualizar registro: Si se reciben todos los datos necesarios del formulario, se inserta o actualiza el registro del estudiante en la base de datos.
 *
 * Manejo de errores:
