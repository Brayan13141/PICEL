    ...
    <section class="container margen">
        <div class="row mt-4">
          <div class="col text-center">
                <h3>¡Bienvenido <?php echo $_SESSION['nombre'].' '.$_SESSION['apellidoP'].' '.$_SESSION['apellidoM'].'!'; ?></h3>
          </div>
        </div>
        <div class="row mt-4">
            <?php
            ...
            <div class="col">
                <div class="card card-main mx-auto" onclick="location.href='rd-main.php';" style="width: 18rem;">
                    ...
                    <div class="card-body"><h4 class="text-center"><strong>Docentes</strong></h4>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card card-main mx-auto" onclick="location.href='re-main.php';" style="width: 18rem;">
                <i class="fa fa-user" aria-hidden="true" style="font-size: 218px;text-align: center;"></i>
                    <div class="card-body"><h4 class="text-center"><strong>Estudiantes</strong></h4>
                    </div>
                </div>
            </div>
            <?php
            ...
            <div class="col">
                ...
                <i class="fa fa-paper-plane " aria-hidden="true" style="font-size: 218px;text-align: center;"></i>
                    <div class="card-body"><h4 class="text-center"><strong>Actividades</strong></h4>
                    </div>
                </div>
            </div>
            <?php
            ...
            ?>
          <div class="col">
                <div class="card card-main mx-auto" onclick="location.href='Actividades_Alumno-main.php';" style="width: 18rem;">
                <i class="fa fa-paper-plane " aria-hidden="true" style="font-size: 218px;text-align: center;"></i>
                    <div class="card-body"><h4 class="text-center"><strong>Mis actividades</strong></h4>
                    </div>
                </div>
            </div>
            <?php
