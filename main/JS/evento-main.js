document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('frm-revento').addEventListener('submit', function () {
    ...
    try {
        $.ajax({
            ...
            success: function (respuesta) {
                window.location.href = "./evento-main.php?mensaje=SE ELIMINO CORRECTAMENTE";
            }
        });
    } catch (e) {
        window.location.href = "./evento-main.php?mensaje=Error al eliminar el registro" + e;
...
function editarEvento(idRegistro) {
    try {
        ...
        window.location.replace('../main/evento-main.php?mensaje=ERROR AL EDITAR EL DOCENTE:' + e);
...
function validarFormulari() {
    ...
    if (periodo.trim() === '') {
        window.location.replace('../main/evento-main.php?mensaje=POR FAVOR INGRESE UN PERIODO VALIDO');
        return false;
    }

    if (nombre.trim() === '') {
        window.location.replace('../main/evento-main.php?mensaje=POR FAVOR INGRESE UN NOMBRE VALIDO');
        return false;
    }

    if (descripcion.trim() === '') {
        window.location.replace('../main/evento-main.php?mensaje=POR FAVOR INGRESE UNA DESCRIPCION VALIDA');
        return false;
    }
